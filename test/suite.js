...
describe("maybe.nothing", () => {
  ...
  describe("#filter(x => false)", () => {
    it("should be Nothing", () => {
      nothing.filter(x => false).should.be.equal(nothing);
    });
  });

  describe("#filter(x => true)", () => {
    it("should be Nothing", () => {
      nothing.filter(x => true).should.be.equal(nothing);
    });
  });
...
describe("maybe.just(0)", () => {
  ...
  describe("#filter(x => false)", () => {
    it("should be Nothing", () => {
      just0.filter(x => false).should.be.equal(nothing);
    });
  });

  describe("#filter(x => true)", () => {
    it("should be equal to itself", () => {
      just0.filter(x => true).should.be.equal(just0);
    });
  });
